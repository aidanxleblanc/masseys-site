...
import img1 from "./prjimg/Gant_1.jpeg";
import img2 from "./prjimg/Gant_2.jpeg";
import img3 from "./prjimg/Gant_3.jpeg";
import img4 from "./prjimg/Gant_4.jpeg";
import img5 from "./prjimg/Gant_5.jpeg";
import img6 from "./prjimg/Gant_6.jpeg";
...
const IndividualProject = ({ url, desc, name, city, state, year, type, arch, owner, contr }) => {
  ...
  return (
    <div className='font-display text-navy justify-center'>
      <Navbar color='navy' />
      <PageTitle title="UCONN Gant Renovation" />
