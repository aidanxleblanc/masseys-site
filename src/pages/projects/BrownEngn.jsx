...
import img1 from "./prjimg/BrownEngn_1.jpeg";
import img2 from "./prjimg/BrownEngn_2.jpeg";
import img3 from "./prjimg/BrownEngn_3.jpeg";
import img4 from "./prjimg/BrownEngn_4.jpeg";
import img5 from "./prjimg/BrownEngn_5.jpeg";
import img6 from "./prjimg/BrownEngn_6.jpeg";
...
const IndividualProject = ({ url, desc, name, city, state, year, type, arch, owner, contr }) => {
  ...
  return (
    <div className='font-display text-navy justify-center'>
      <Navbar color='navy' />
      <PageTitle title="Brown University School of Engineering" />
