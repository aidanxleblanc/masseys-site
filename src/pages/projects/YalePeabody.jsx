...
import img1 from "./prjimg/Peabody_1.jpeg";
import img2 from "./prjimg/Peabody_2.jpeg";
import img3 from "./prjimg/Peabody_3.jpeg";
import img4 from "./prjimg/Peabody_4.jpeg";
import img5 from "./prjimg/Peabody_5.jpeg";
...
const IndividualProject = ({ url, desc, name, city, state, year, type, arch, owner, contr }) => {
  ...
  return (
    <div className='font-display text-navy justify-center'>
      <Navbar color='navy' />
      <PageTitle title="Yale Peabody Museum" />
