...
import img1 from "./prjimg/Friar_1.jpeg";
import img2 from "./prjimg/Friar_2.jpeg";
import img3 from "./prjimg/Friar_3.jpeg";
import img4 from "./prjimg/Friar_4.jpeg";
import img5 from "./prjimg/Friar_5.jpeg";
import img6 from "./prjimg/Friar_6.jpeg";
...
const IndividualProject = ({ url, desc, name, city, state, year, type, arch, owner, contr }) => {
  ...
  return (
    <div className='font-display text-navy justify-center'>
      <Navbar color='navy' />
      <PageTitle title="Providence College Friar Center" />
