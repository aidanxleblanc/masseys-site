...
import img1 from "./prjimg/Earth.jpeg";
import img2 from "./prjimg/Earth_2.jpeg";
import img3 from "./prjimg/Earth_3.jpeg";
import img4 from "./prjimg/Earth_4.jpeg";
...
const IndividualProject = ({ url, desc, name, city, state, year, type, arch, owner, contr }) => {
  ...
  return (
    <div className='font-display text-navy justify-center'>
      <Navbar color='navy' />
      <PageTitle title="Mohegan Sun Earth Hotel" />
