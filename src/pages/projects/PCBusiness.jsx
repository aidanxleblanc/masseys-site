...
import img1 from "./prjimg/PCBusiness_1.jpeg";
import img2 from "./prjimg/PCBusiness_2.jpeg";
import img3 from "./prjimg/PCBusiness_3.jpeg";
...
const IndividualProject = ({ url, desc, name, city, state, year, type, arch, owner, contr }) => {
  ...
  return (
    <div className='font-display text-navy justify-center'>
      <Navbar color='navy' />
      <PageTitle title="Providence College School of Business" />
