...
import img1 from "./prjimg/Stamford_1.jpeg";
import img2 from "./prjimg/Stamford_2.jpeg";
import img3 from "./prjimg/Stamford_3.jpeg";
import img4 from "./prjimg/Stamford_4.jpeg";
...
const IndividualProject = ({ url, desc, name, city, state, year, type, arch, owner, contr }) => {
  ...
  return (
    <div className='font-display text-navy justify-center'>
      <Navbar color='navy' />
      <PageTitle title="Stamford Hospital" />
